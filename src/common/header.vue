        ...
        <div class="w-box">
          ...
          <div class="right-box">
            <div class="nav-list">
              ...
              <router-link to="/logs"><a>足迹</a></router-link>
            </div>
            <div class="nav-aside" ref="aside" :class="{fixed:st}">
              <div class="user pr">
                <router-link to="/user">个人中心</router-link>
                <!--用户信息显示-->
                <div class="nav-user-wrapper pa" v-if="this.token">
                  <div class="nav-user-list">
                    <ul>
                      <!--头像-->
                      <li class="nav-user-avatar">
                        <div>
                          <span class="avatar" :style="{backgroundImage:'url('+this.avatar+')'}">
                          </span>
                        </div>
                  ...
                  <div class="nav-user-list">
                    <div class="full" v-show="totalNum">
                      ...
                      <div class="nav-cart-items">
                        <ul>
                          <li class="clearfix" v-for="(item,i) in this.cartList" :key="i">
                            <div class="cart-item">
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .cart-con:before {
    ...
    width: 76px;
    height: 62px;
    background: url(../assets/images/cart-empty-new.png) no-repeat;
    background-size: cover;
