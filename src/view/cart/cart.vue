  ...
  methods: {
    ...
    editCheckAll () {
      ...
      editCheckAll(checkAll).then(res => {
        if (res.code === 20000) {
          this.$store.dispatch('cart/editCart', { checked: checkAll })
        }
    ...
    _cartEdit (productId, productNum, checked) {
      cartEdit(productId, checked).then(res => {
        if (res.code === 20000) {
          this.$store.dispatch('cart/editCart', { productId, productNum, checked })
          // this.EDIT_CART(
          //   {
          //     productId,
          //     checked,
    ...
    editCart (type, item) {
      if (type && item) {
        ...
        this.$root.$message.error('缺少所需参数')
      }
    },
    ...
    cartdel (productId) {
      delCart(productId).then(res => {
        if (res.code === 20000) {
          this.$store.dispatch('cart/editCart', { productId })
        } else {
          this.$root.$message.error('删除失败')
        }
...
<style lang="scss" rel="stylesheet/scss" scoped>
    ...
    .ui-cart {
      ...
      .cart-items {
        ...
        .operation {
          ...
          .items-delete-btn {
            background-image: url(../../assets/images/delete-btn-icon_a35bf2437e@2x.jpg);
          ...
          .items-delete-btn {
            ...
            margin: 0 auto;
            color: #C2C2C2;
            background: url(../../assets/images/delete-btn-icon_a35bf2437e@2x.jpg);
  ...
  .page-cart {
    ...
    .blue-checkbox-new, .blue-checkbox-new.checkbox-disable, .blue-checkbox-new.checkbox-on {
      ...
      width: 20px;
      height: 20px;
      background: url(../../assets/images/checkbox-new_631a56a4f6.png) no-repeat 0 -20px;
      cursor: pointer;
    ...
    .blue-checkbox-new.checkbox-on, .choose-checkbox-on .blue-checkbox-new {
      background: url(../../assets/images/checkbox-new_631a56a4f6.png) no-repeat 0 0;
    }
  ...
  .cart-e {
    margin: 0 auto;
    background: url("../../assets/images/cart-empty_@2x.png") no-repeat;
    width: 275px;
    height: 300px;
    color: #8d8d8d;
  }
