<template>
  <div>
    <y-shelf title="收货地址">
      <span slot="right"><my-button text="添加收货地址" style="margin: 0" @btnClick="update()"></my-button></span>
      <div slot="content">
        <!--标题-->
        ...
        <div v-if="addList.length">
          <div class="address-item" v-for="(item,i) in addList" :key="i">
            ...
            <div class="operation">
              <el-button type="primary" icon="el-icon-edit-outline" size="small" @click="update(item)"></el-button>
              <el-button type="danger" icon="el-icon-delete-solid" size="small" :data-id="item.addressId"
        ...
        <div v-else>
          <div style="padding: 80px 0;text-align: center">
            ...
            <div style="margin: 20px ">
              <my-button text="添加地址" @btnClick="update()"></my-button>
            </div>
          </div>
        </div>
      </div>
